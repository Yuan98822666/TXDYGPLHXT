...
class SpecialZt(Base):
    __tablename__ = "special_zt"
    ...
    __table_args__ = (
        Index("ix_special_zt_code_date", "stock_code", "trade_date", unique=True),
        {"comment": "涨停池表"},
    )

    def __repr__(self):
        return f"<SpecialZt code={self.stock_code} name={self.stock_name}>"
